...
5. Double-click the file named MultiWorld-Setup.exe to start the installation.
6. Follow the prompts on the screen to place the program on your computer.
...
1. Select a preset scenario from the File menu.
2. Click the Load button.
3. Wait for the model to prepare the environment.
4. Use your mouse to navigate the view.
5. Input your choices in the agent configuration panel.
6. Press the Play button to start the video generation process.
...
- Simulation crashes: Close other demanding programs—like web browsers or video games—to free up system memory.
